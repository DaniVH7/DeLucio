                        ...
                        content: [
                            ...
                            
                            {
                                table: {
                                    ...
                                    headerRows: 1,
                                    body: [
                                        ["cabezal_frontal","cabezal_trasero", "piso"],
                                        ...datos.map(row => [
                                            row.cabezal_frontal,
                                            row.cabezal_trasero,
                                            row.piso,
                            ...
                            },
                            {
                                table: {
                                    ...
                                    headerRows: 1,
                                    body: [
                                        ["gancho_arrastre", "perno_rey", "porta_llantas", "caja_herramientas"],
                                        ...datos.map(row => [
                                            row.gancho_arrastre,
                                            row.perno_rey,
                                            row.porta_llantas,
                            ...
                            },
                            {
                                table: {
                                    ...
                                    headerRows: 1,
                                    body: [
                                        ["frenos_neu", "eje_retractil", "guarda"],
                                        ...datos.map(row => [
                                            row.frenos_neu,
                                            row.eje_retractil,
                                            row.guarda,
